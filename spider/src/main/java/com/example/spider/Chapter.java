...
//设置Adapter
                    ...
                    adapter.setOnitemClickLintener(new GeneralAdapter.OnitemClick() {
                        ...
                        public void onItemClick(int position) {
                            ...
                            bundle.putInt("total_chapter",ChapterUrl.length);
                            bundle.putCharSequence("book_title",name);
                            bundle.putCharSequence("book_url",url);
                            bundle.putCharSequence("url",ChapterUrl[position]);
                            bundle.putCharSequence("chapter_title", ChapterTitle[position]);
